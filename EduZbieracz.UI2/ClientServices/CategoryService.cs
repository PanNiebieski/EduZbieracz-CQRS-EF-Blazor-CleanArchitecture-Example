...
namespace EdoZbieracz.UI.ClientServices
{
    public class CategoryService : ICategoryService
    {
        ...
        public async Task<ResponseFromApi<int>> CreateCategory(CategoryViewModel categoryViewModel)
        {
            try
            {
        ...
        public async Task<List<CategoryWithPostsViewModel>> GetAllCategoriesWithPosts(SearchCategoryOptions searchCategoryOptions)
        {
            var allCategories = await _client.GetCategoriesWithPostsAsync(searchCategoryOptions);
            var mappedCategories = _mapper.Map<ICollection<CategoryWithPostsViewModel>>(allCategories);
            return mappedCategories.ToList();
        }
